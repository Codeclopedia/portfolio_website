  ...
  return (
    <div className="absolute inset-0" ref={techStackRef} style={{visibility:"hidden"}}>
      {[
        ...
        { iconName: "next", left: "w-[100px] left-[250px] sm:left-[400px] md:left-[460px] lg:left-[500px] xl:left-[550px]", bottom: "bottom-[470px] md:bottom-16", rotate: "-rotate-12", animate: "animate-levitate3", z: "z-20", width: 150, height: 100 },
        { iconName: "mongo", right: "right-[100px] lg:right-[420px] xl:right-[400px]", bottom: "bottom-[200px] sm:bottom-[170px] lg:bottom-[90px] xl:bottom-[120px]", rotate: "-rotate-12", animate: "animate-levitate", z: "z-30", width: 150, height: 150 },
        ...
        { iconName: "postgres", left: "left-[280px] sm:left-[320px] md:left-[420px]", bottom: "bottom-[250px] sm:bottom-[140px] md:bottom-32", rotate: "-rotate-12", animate: "animate-levitate3", z: "z-50", width: 80, height: 70 },
        { iconName: "node", right: "right-[300px] sm:right-[450px] md:right-80", bottom: "bottom-[300px]", rotate: "-rotate-12", animate: "animate-levitate4", z: "z-60", opacity: "opacity-90", width: 150, height: 150 },
        { iconName: "javascript", left: "left-[30px] sm:left-[450px] md:left-[740px]", bottom: "bottom-[200px] sm:bottom-[180px] md:bottom-24", rotate: "-rotate-12", animate: "animate-levitate5", z: "z-70", width: 80, height: 80 },
        { iconName: "react", right: "right-[480px] lg:right-[320px] xl:right-[340px]", bottom: "bottom-[250px] md:bottom-[200px]", rotate: "-rotate-12", opacity: "opacity-90", animate: "animate-levitate5", z: "z-80", width: 100, height: 150 },
        { iconName: "reactNative", left: "left-[290px] sm:left-[180px] lg:left-[700px] xl:left-[870px]", bottom: "bottom-[380px] sm:bottom-[480px] md:bottom-[450px]", rotate: "-rotate-12", animate: "animate-levitate5", z: "z-90", opacity: "opacity-60", width: 70, height: 100 },
        ...
        { iconName: "sql", right: "right-[10px] sm:right-12", bottom: "bottom-12", rotate: "rotate-8", animate: "animate-levitate3", z: "-z-120", opacity: "opacity-5", width: 100, height: 100 },
        ...
        { iconName: "appwrite", right: "right-[250px]", bottom: "top-[100px] sm:bottom-[500px]", rotate: "rotate-7", animate: "animate-levitate3", z: "-z-300", opacity: "opacity-10", width: 120, height: 100 },
        ...
        { iconName: "flutter", left: "left-[0px] sm:left-[500px] md:left-[350px]", bottom: "bottom-[380px] sm:bottom-[270px] md:bottom-[250px]", rotate: "rotate-10", animate: "animate-levitate", z: "z-200", width: 80, height: 110 },
        ...
        { iconName: "gsap", left: "left-[80px] sm:left-[450px]", bottom: "bottom-[450px] sm:bottom-[400px]", rotate: "rotate-8", animate: "animate-levitate4", z: "z-200", opacity: "opacity-70", width: 70, height: 70 },
      ].map((props, index) => (
