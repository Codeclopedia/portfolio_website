  ...
  return (
    <div className="absolute inset-0" ref={techStackRef} style={{visibility:"hidden"}}>
      {[
        ...
        { iconName: "next", left: "w-[100px] left-[250px] sm:left-[400px] md:left-[540px]", bottom: "bottom-[470px] md:bottom-16", rotate: "-rotate-12", animate: "animate-levitate3", z: "z-20", width: 150, height: 100 },
        { iconName: "mongo", right: "right-[100px] sm:right-[400px]", bottom: "bottom-[200px] sm:bottom-[170px] md:bottom-[120px]", rotate: "-rotate-12", animate: "animate-levitate", z: "z-30", width: 150, height: 150 },
        ...
        { iconName: "reactNative", left: "left-[290px] sm:left-[180px] md:left-[870px]", bottom: "bottom-[380px] sm:bottom-[480px] md:bottom-[450px]", rotate: "-rotate-12", animate: "animate-levitate5", z: "z-90", opacity: "opacity-60", width: 70, height: 100 },
