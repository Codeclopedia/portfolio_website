...
interface ServicesButtonsProps {
  ...
  selectedIndex: number; // Added index to track selected button
  onButtonClick: (index: number) => void; // Callback to update selected index
}
        ...
        <button
          ...
          className={`text-xl ${
            index === selectedIndex
              ...
              : "bg-transparent text-black" // Default style
          }`}
        >
