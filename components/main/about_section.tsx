...
function AboutTextSection() {
  return (
    <div className="mb-0 h-min">
      ...
      <h5 className="w-[600px] text-xs sm:text-md md:text-xl">Driven by passion and fueled by creativity, I strive to turn ideas into impactful realities through dedication and innovation.</h5>
    </div>
  );
}
...
function ComputerDisplay() {
  return (
    <div className="flex flex-wrap justify-between items-start w-full h-min">
      <DesignList />
    </div>
  );
}
